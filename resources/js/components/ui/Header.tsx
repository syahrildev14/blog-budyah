            ...
            <div className='sticky top-0 z-50'>
                ...
                <header className="h-16 bg-white border-b flex items-center justify-around px-6">
                    <nav className="flex gap-12">
                        ...
                        <Link href="/materi" className="text-gray-600 hover:text-red-600">
                            Materi
                        </Link>
                        <Link href="/cerita-lucu" className="text-gray-600 hover:text-red-600">
                            Cerita Lucu
                        </Link>
                        <Link href="/cerita-misteri" className="text-gray-600 hover:text-red-600">
                            Cerita Misteri
                        </Link>
                        <Link href="/cerita-cinta" className="text-gray-600 hover:text-red-600">
                            Cerita Cinta
                        </Link>
                        <Link href="/cerita-anak" className="text-gray-600 hover:text-red-600">
                            Cerita Anak
                        </Link>
                        <Link href="/cerita-kehidupan" className="text-gray-600 hover:text-red-600">
                            Cerita Kehidupan
                        </Link>
