            ...
            <header className="h-16 flex items-center justify-between md:justify-around px-4">
                ...
                >
                    <img
                        src={Logo}
                        alt="E-Cerkak"
                        className="w-20 md:w-28 object-contain group-hover:scale-105 transition-transform duration-300"
                    />

                    <div className="leading-0">
                        <h1 className="text-lg md:text-4xl font-extrabold text-red-600 group-hover:text-red-700 transition-colors">
                            E-Cerkak
                        </h1>

                        <p className="text-xs md:text-base text-red-600 tracking-wide">
                ...
                <div className="md:hidden border-t bg-white px-4 py-4 space-y-1">
                    ...
                    <div className="pt-2">
                        ...
                        >
                            ...
                            <ChevronDown
                                className={`w-4 h-4 transition-transform ${openKategori ? 'rotate-180' : ''
                                    }`}
                            />
                        </button>
