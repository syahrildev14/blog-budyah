...
export default function CeritaKehidupan() {
    return (
        <>
            <Head title="Cerita Kehidupan" />

            <section className="bg-white rounded-md p-6">
                <h2 className="text-3xl font-semibold mb-6">Cerita Kehidupan</h2>
...
CeritaKehidupan.layout = (page: any) => <AppLayout>{page}</AppLayout>;
