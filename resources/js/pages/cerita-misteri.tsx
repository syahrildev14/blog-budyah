    ...
    return (
        <>
            ...
            <section className="space-y-8">
                <h1 className='font-bold border-b-4 border-red-600 text-3xl text-gray-800'>Cerita Misteri</h1>
                {posts.map((post) => (
                    <Link
                        key={post.id}
...
CeritaMisteri.layout = (page: React.ReactNode) => <AppLayout>{page}</AppLayout>
